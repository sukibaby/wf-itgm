...
for i = 1, 10 do
    ...
    row[#row+1] = LoadFont(Font)..{
        ...
        AddRPGLeaderboardCommand = function(self, arg)
            if arg and arg[i] then
                self:settext(string.format("%0.2f%%", arg[i]["score"]/100))
