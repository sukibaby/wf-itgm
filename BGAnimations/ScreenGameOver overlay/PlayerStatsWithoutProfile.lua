...
for i,stats in pairs( SL[ToEnumShortString(player)].Stages.Stats ) do
	...
	-- note: leaving this here for now in case i want to bring it back, but right now i am removing
	-- "notes hit this game" from the screen
...
if hours > 0 then
	lines[2] = ScreenString("TimeSpentThisGame") .. "\n"..
